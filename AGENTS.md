...
По умолчанию отвечай коротко: только важные статусы, решения, ошибки и итог. Не пересказывай длинные логи, не делай большие планы без просьбы, не объясняй очевидное. Подробно отвечай только если Егор попросил, если есть риск сломать проект, или если без объяснения решение будет непонятным.
...
- **ВСЕГДА ИСПОЛЬЗУЙ LSP** — после любого редактирования кода, при поиске чего-либо, при переименовании, при проверке ошибок — ВСЕГДА вызывай LSP-инструменты (lsp_diagnostics, lsp_goto_definition, lsp_find_references, lsp_rename, lsp_symbols). Это беспрекословное правило которое никогда нельзя нарушать. Не читай файлы вручную когда можно получить точную информацию через LSP
