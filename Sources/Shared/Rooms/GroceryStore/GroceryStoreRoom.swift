    ...
    private static func makeClerk() -> ItemDefinition {
        ItemDefinition(
            ...
            fullDescriptionProvider: { _ in
                "Перед тобой продавец за длинным прилавком. Он спокойно ждет вопроса.\n\nЕго действия:\n• E — спросить что есть\n• F — попросить кружку\n• Пробел — купить пакетик чая (2 монеты)\n• Долгое E — купить сахар (1 монета)\n\nНа ценнике: пакетик чая — 2 монеты, сахар — 1 монета."
            },
